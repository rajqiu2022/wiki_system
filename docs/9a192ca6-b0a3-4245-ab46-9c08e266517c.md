...
This document provides detailed instructions on how to connect the **DC-Motor** device to your deployed Home Assistant environment.
...
## 3. Creat a new DC-Motor device in ESPHome
...
- **Overwrite** or **merge** all the configuration content from [ha-motor.yaml](https://github.com/Makerfabs/Home-Assistant-DC-Motor) into your own device's YAML file.
...
![image.png](https://www.makerfabs.com/desfile/images/2023.10.24%20DC%20Motor%20for%20Home%20Assistant_GA36Y-555.gif)
...
- [GitHub](https://github.com/Makerfabs/Home-Assistant-DC-Motor)
