# How to use OV3660 3M Camera for Home Assistant

# How to use Camera for Home Assistant

This document provides detailed instructions on how to connect the **Home Assistant OV3660 3M Camera** device to your deployed Home Assistant environment.
...
- An Home Assistant OV3660 3M Camera.
- A USB-C cable.
...
- **Overwrite** or **merge** all the configuration content from [ha-camera.yaml](https://github.com/Makerfabs/Home-Assistant-Camera-OV3660/blob/main/config/ha-camera.yaml) into your own device's YAML file.
...
![image-20260123114809771](https://easyimage.linwanrong.com/i/2026/01/23/izkvti-0.webp)
...
![result](https://easyimage.linwanrong.com/i/2026/01/29/i7tnw5-0.gif)
...
- [GitHub](https://github.com/Makerfabs/Home-Assistant-Camera-OV3660)
