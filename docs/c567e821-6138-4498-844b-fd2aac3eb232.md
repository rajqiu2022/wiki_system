# How to 8 Channel button controller for Home Assistant

# How to use 8 Channel button controller for Home Assistant

This document provides detailed instructions on how to connect the **8 Channel button controller** device to your deployed Home Assistant environment.
...
- An 8 Channel button controller.
- A USB-C cable.
...
## 3. Creat a new button controller device in ESPHome
...
- **Overwrite** or **merge** all the configuration content from [button8.yaml](https://github.com/Makerfabs/Home-Assistant-Controller-8-Channel) into your own device's YAML file.
...
![image.png](https://www.makerfabs.com/desfile/images/Channel%20button%20controller%20for%20Home%20Assitant-1.gif)
...
- [GitHub](https://github.com/Makerfabs/Home-Assistant-Controller-8-Channel)
