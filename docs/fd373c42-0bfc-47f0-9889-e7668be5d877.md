# How to use Energy Meter for Home Assistant

# How to use Energy Meter for Home Assistant

This document provides detailed instructions on how to connect the **Energy Meter** device to your deployed Home Assistant environment.

![image](https://www.makerfabs.com/media/catalog/product/cache/5082619e83af502b1cf28572733576a0/e/n/energy_meter_for_home_assistant-9.jpg)

Model:[HANER01](https://www.makerfabs.com/energy-meter-for-home-assistant.html)
...
## 3. Creat a new energy meter device in ESPHome
...
- **Overwrite** or **merge** all the configuration content from [ha-energy.yaml](https://github.com/Makerfabs/Home-Assistant-Energy-Meter/blob/main/config/ha-energy.yaml) into your own device's YAML file.
...
![image-20260103152937363](https://easyimage.linwanrong.com/i/2026/01/03/pakeml-0.webp)
...
![6C4B9](https://easyimage.linwanrong.com/i/2026/01/03/p5qdel-0.gif)
...
- [GitHub](https://github.com/Makerfabs/Home-Assistant-Energy-Meter)
